    ...
    protected void onCreate(Bundle savedBundleInstance) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                stickerList.add(new Pair<>(cool, R.drawable.cool));
                stickerList.add(new Pair<>(annoyed, R.drawable.annoyed));
                stickerList.add(new Pair<>(cry, R.drawable.cry));
                stickerList.add(new Pair<>(smile, R.drawable.smile));
                stickerList.add(new Pair<>(irritated, R.drawable.irritated));
                stickerList.add(new Pair<>(think, R.drawable.think));
                stickerList.add(new Pair<>(wink, R.drawable.wink));
                stickerList.add(new Pair<>(surprised, R.drawable.surprised));
                stickerList.add(new Pair<>(sobbing, R.drawable.sobbing));
                stickerList.add(new Pair<>(sick, R.drawable.sick));
                stickerList.add(new Pair<>(money, R.drawable.money));
                stickerList.add(new Pair<>(monkey, R.drawable.money));
                stickerList.add(new Pair<>(liar, R.drawable.liar));
                stickerList.add(new Pair<>(cold, R.drawable.cold));
                stickerList.add(new Pair<>(eyes, R.drawable.eyes));
                stickerList.add(new Pair<>(king, R.drawable.king));
                stickerList.add(new Pair<>(queen, R.drawable.queen));
                stickerList.add(new Pair<>(panda, R.drawable.panda));
                stickerList.add(new Pair<>(flower, R.drawable.flower));
                stickerList.add(new Pair<>(poop, R.drawable.poop));
